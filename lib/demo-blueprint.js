...
const texts = {
  ...
  astrology: {
    qualities: {
      ...
      southNode: 'Waar je vandaan komt: gezien willen worden als jezelf, vaak op de achtergrond geleefd. Moeiteloos, en niet meer voedend',
      chiron: 'Wond en heling rond je recht om je eigen kant te kiezen, in het huis van betekenis en geloof',
      mc: 'Wat je hier komt brengen vraagt om geduld en degelijkheid: iets neerzetten dat blijft staan',
    },
    aspects: [
      'Je groeikracht en je vermogen tot verdieping werken moeiteloos samen; veranderen gaat bij jou via kleine, gestage stappen.',
      'Structuur en verbeelding staan bij jou tegenover elkaar: het plan wil houvast, het verlangen wil betekenis. Die spanning vraagt om balans, niet om een winnaar.',
      'Wat je liefhebt en wat je doet stromen samen; je zet je in voor mensen en dat kost je opvallend weinig moeite.',
      'Je gevoelige plek en je groeirichting geven elkaar een kans: juist waar het schuurt, ligt een deur naar je bijdrage.',
      'Wie je bent en wat je wilt neerzetten in de wereld ondersteunen elkaar; je warmte is zichtbaar in je werk.',
      'Je kern en je behoefte aan vernieuwing schuren: rust en verandering trekken allebei aan je. Dat is wrijving die groei afdwingt.',
      'Hoe je liefhebt en hoe je verschijnt liggen op één lijn; contact maken gaat bij jou vanzelf.',
      'Wat je voelt en wat je bouwt ondersteunen elkaar; je emoties krijgen vorm via woorden en afspraken.',
      'Je gevoel en je verlangen naar betekenis wijzen dezelfde kant op: een kans die je bewust mag oppakken.',
    ],
    patterns: P(
  ...
  energy: {
    ...
    elements: [
      { label: 'Lucht · 5 punten (Maan in Weegschaal, Venus en Saturnus in Tweelingen, Mars in Waterman, Uranus in Weegschaal)', title: 'Verbinding, beweging en bijdrage', body: 'Dit is je grootste voorraad. In de lucht leeft je gerichtheid op anderen, op uitwisseling en op het collectief. Hier wijst ook je groeirichting: bijdragen aan het geheel via concreet werk. Beweeg naar buiten, deel, draag bij.' },
      { label: 'Water · 3 punten (Zon en Mercurius in Kreeft, Jupiter in Schorpioen)', title: 'Gevoeligheid en geheugen', body: 'Je voelt en onthoudt veel, en je bent sterk verbonden met wat geweest is. Vertrouw op wat je voelt, niet alleen op wat je beredeneert. (Zon en Mercurius in Kreeft.)' },
      { label: 'Vuur · 2 punten (Neptunus in Boogschutter, Ascendant in Leeuw)', title: 'Eigen koers en warmte', body: 'Je vuur zit in hoe je verschijnt en in je verlangen naar betekenis. Het draagt het thema van je eigen richting durven kiezen en zichtbaar durven zijn.' },
      { label: 'Aarde · 2 punten (Pluto in Maagd, MC in Stier)', title: 'Jouw minst vertegenwoordigde element', body: 'Aarde is het langzame, het praktische, het geduld om iets te laten bezinken. Daar heb je twee punten van, en allebei op de achtergrond. Dit is gereedschap dat je bewust mag ophalen: iets traags en lijfelijks doen zonder dat er een resultaat aan vastzit.' },
    ],
    modality: {
      title: 'En hoe je in balans beweegt',
      body: 'Naast elementen heeft elk teken een kwaliteit: cardinaal begint dingen, vast houdt vol, beweeglijk verandert van koers. Jouw verdeling is zeldzaam gelijkmatig: vier cardinaal, vier vast en vier beweeglijk. Je kunt starten, volhouden én bijsturen; de vraag is nooit of je het kunt, maar welke van de drie je op dit moment kiest.',
    },
  },
  integration: {
    layers: {
...
texts.calendar = {
  intro: P('De maandgetallen tot en met december zijn berekend vanuit Persoonlijk Jaar 1. Op 1 januari 2027 gaat je persoonlijk jaar naar een 2, en januari en februari zijn daaruit berekend. Daaronder staat per maand ook wat er astronomisch gebeurt ten opzichte van jouw geboortekaart.'),
  months: [
    { theme: 'Beginnen', body: 'Een 1 in een 1-jaar: het sterkste startsignaal dat de numerologie kent. Begin iets kleins dat puur van jou is.', bullets: ['Zet een eerste stap vanuit wat jij wilt', 'Begin iets kleins dat puur van jou is', 'Neem het initiatief, wacht niet af'] },
    { theme: 'Aanvoelen', body: 'Een meestermaand met verhoogde gevoeligheid, en die wordt niet gereduceerd. Maak ruimte voor stilte en luister naar wat je van binnen voelt.', bullets: ['Maak ruimte voor stilte', 'Volg je gevoel voordat je het wegredeneert', 'Let op wat zich aandient'] },
    { theme: 'Laten zien', body: 'De 3 wil naar buiten. Deel wat je maakt en geniet van je mensen.', bullets: ['Deel openlijk wat in je leeft', 'Doe iets puur omdat het je vreugde geeft', 'Geniet bewust van je vrienden'] },
    { theme: 'Neerzetten', body: 'De 4 bouwt. Een maand om af te maken en stevigheid te bouwen onder wat je begonnen bent.', bullets: ['Maak af waar je aan begonnen bent', 'Breng orde aan, één ding tegelijk', 'Doe het langzamer dan je gewend bent'] },
    { theme: 'Verbinden', body: 'Opnieuw een 3, nu in een 2-jaar: expressie in samenspel. Laat je zien, en doe het samen.', bullets: ['Deel iets voordat het af is', 'Zoek een ander op bij wat je maakt', 'Vier wat er al staat'] },
    { theme: 'Verankeren', body: 'Een 4 om vast te leggen wat er sinds september is veranderd, in plaats van terug te vallen in het oude.', bullets: ['Zet vast wat je in september bent begonnen', 'Kijk terug zonder oordeel', 'Vraag iemand om mee te kijken'] },
  ],
};
