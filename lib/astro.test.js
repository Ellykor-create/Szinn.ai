...
const CHARTS = [
  ...
  // Bron: gecorrigeerd referentiedocument sept 2026 (ware knoop Weegschaal 14°59')
  ['Kudelstaart','1977-11-07','21:55', 52.235,   4.755, 'Europe/Amsterdam',
    { asc:['Leeuw',1,6], mc:['Ram',5,56], sun:['Schorpioen',15,20,4], moon:['Maagd',29,28,3],
      nn:['Weegschaal',14,59,4], chiron:['Stier',2,52,10,true], saturn:['Leeuw',29,31,2] }],
];

const KEY = { asc:'ascendant', mc:'mc', sun:'sun', moon:'moon', mars:'mars',
  saturn:'saturn', uranus:'uranus', nn:'northNode', chiron:'chiron' };
