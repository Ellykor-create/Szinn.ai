...
const MODEL = () => process.env.BLUEPRINT_MODEL || 'claude-haiku-4-5';
...
- MAAK ZICHTBAAR WAT ER IS — verzin niets. Elke uitspraak moet herleidbaar zijn tot de aangeleverde kaart, getallen of vragenlijst-antwoorden. Geen posities, huizen of getallen benoemen die niet in de data staan. Bij twijfel: laat het weg. Controleer jezelf dubbel; niets "erbij praten".
...
- Geen medische of psychologische claims. Het document is een spiegel en een uitnodiging, geen voorspelling.
